...
local Strings = {
    en = {
        ...
        register_error       = "Couldn't record the book: {}",
        reached_end          = 'You have reached the end of "{}". Record it as finished in TaleTrack?',
        yes                  = "Yes",
        no                   = "No",
    ...
    es = {
        ...
        register_error       = "Error al registrar el libro: {}",
        reached_end          = 'Has llegado al final de "{}". ¿Registrarlo como finalizado en TaleTrack?',
        yes                  = "Sí",
        no                   = "No",
